//This file is a copy of https://github.com/CesiumGS/cesium/blob/main/Specs/addDefaultMatchers.js
...
], function (equals, defined, DeveloperError, RuntimeError) {
    'use strict';
        ...
        return {
            ...
            toStartWith: function (util, customEqualityTesters) {
                return {
                    compare: function (actual, expected) {
                        return {
                            pass: actual.slice(0, expected.length) === expected
                        };
                    }
                };
            },
            ...
            toEndWith: function (util, customEqualityTesters) {
                return {
                    compare: function (actual, expected) {
                        return {
                            pass: actual.slice(-expected.length) === expected
                        };
                    }
                };
            },
            ...
            toConformToInterface: function (util, customEqualityTesters) {
                return {
                    compare: function (actual, expectedInterface) {
                        ...
                        const expectedInterfacePrototype =
                            expectedInterface.prototype;
                        ...
                        for (const item in expectedInterfacePrototype) {
                            if (
                                ...
                                typeof expectedInterfacePrototype[item] ===
                                    'function' &&
                                !Object.prototype.hasOwnProperty.call(
                                    actualPrototype,
                                    item
            ...
            toThrow: function (expectedConstructor) {
                throw new Error(
                    'Do not use toThrow.  Use toThrowDeveloperError or toThrowRuntimeError instead.'
                );
            },
            ...
            toThrowRuntimeError: makeThrowFunction(
                true,
                RuntimeError,
                'RuntimeError'
            )
