...
export class ValidationOptions {
  ...
  /**
   * Whether validation issues that are generated by the glTF-Validator
   * should be retained, even when they are obsolete due to the extensions
   * being known or supported by the 3D Tiles Validator.
   */
  private _verboseGltfValidation: boolean;
   ...
   * - `verboseGltfValidation = false`, causing obsolete issues to be omitted
  ...
  constructor() {
    ...
    this._verboseGltfValidation = false;
  ...
  /**
   * The flag that indicates whether obsolete issues from
   * the glTF validator should be retained.
   */
  get verboseGltfValidation(): boolean {
    return this._verboseGltfValidation;
  }

  set verboseGltfValidation(value: boolean) {
    this._verboseGltfValidation = value;
  }
